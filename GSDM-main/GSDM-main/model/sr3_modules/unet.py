...
class FeatureWiseAffine(nn.Module):
    ...
    def __init__(
        ...
        mult = 2 if self.use_affine_level else 1
    ...
    def __init__(
        ...
        for ind in range(num_mults):
            ...
            if not is_last:
                ...
                downs.append(
                    Downsample(pre_channel)
                )

                feat_channels.append(pre_channel)

                now_res[0] = now_res[0] // 2
                now_res[1] = now_res[1] // 2
